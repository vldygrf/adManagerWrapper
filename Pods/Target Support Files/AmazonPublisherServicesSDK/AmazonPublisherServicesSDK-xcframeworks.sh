...
install_xcframework "${PODS_ROOT}/AmazonPublisherServicesSDK/APS_iOS_SDK-4.3.1/DTBiOSSDK.xcframework" "AmazonPublisherServicesSDK" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
