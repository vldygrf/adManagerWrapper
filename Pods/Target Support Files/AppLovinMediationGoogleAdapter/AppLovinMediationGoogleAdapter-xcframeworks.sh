...
install_xcframework "${PODS_ROOT}/AppLovinMediationGoogleAdapter/AppLovinMediationGoogleAdapter-9.9.0.0/AppLovinMediationGoogleAdapter.xcframework" "AppLovinMediationGoogleAdapter" "library" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
